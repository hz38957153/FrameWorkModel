package com.frame.model.widget;
...
import com.frame.model.utils.util.GetResources;
...
public class NetworkStateView extends LinearLayout {
    ...
    public NetworkStateView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.NetworkStateView_nsvTextSize, DensityUtil.dp2px(14));
